...
class BlackJackDeck extends Component<BlackJackProp, BlackJackState>{
    ...
    stayYN: number = 0;
    gameEnd: number = 0;
    bustedPlayer: number | String = 0;
    bustedHouse: number | String = 0;
    ...
    override render(): ReactNode {
        ...
        if (this.totalPlayer == 999)this.bustedPlayer="BUSTED";
        this.bustedHouse = this.totalHouse;
        if (this.totalHouse == 999)this.bustedHouse="BUSTED";
    ...
    stayButton(): void {
        ...
        while (this.totalHouse < 17) this.addCardHouse();

        if (!this.gameEnd)newState.whoWon = "Push no Winners";
        newState.whoWon = "House Busted, You Won.";
        if (this.totalPlayer > this.totalHouse && !this.gameEnd)newState.whoWon = "Player has Won";
        if (this.totalPlayer < this.totalHouse && !this.gameEnd)newState.whoWon = "House has Won";
        this.gameEnd = 1;
        this.setState( newState );
    }
}
